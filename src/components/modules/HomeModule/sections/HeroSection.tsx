...
import * as HeroImageRobot from '../../../../../public/hero-robot.svg'
...
export const HeroSection: React.FC = () => {
  return (
    <section className="w-full flex flex-col items-center gap-8 md:gap-16 xl:gap-20 overflow-hidden">
      <div className="flex flex-col gap-4 w-full xl:w-[90%] text-center justify-center md:justify-normal">
        ...
        <Link
          href={'/projects'}
          className="flex items-center justify-center place-self-center px-6 py-3 md:px-8 md:py-3 mt-10 mb-10 md:mb-0 bg-[#3A0CA3] hover:bg-[#3A0CA3]/70 rounded-lg w-full md:w-fit 
